...
export const ORDER__LIST_REQUEST = "ORDER__LIST_REQUEST";
export const ORDER__LIST_SUCCESS = "ORDER__LIST_SUCCESS";
export const ORDER__LIST_FAIL = "ORDER__LIST_FAIL";
export const ORDER__LIST_RESET = "ORDER__LIST_RESET";
